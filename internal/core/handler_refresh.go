...
func (t *TLDR) Refresh(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		t.errorResponse(w, http.StatusUnauthorized, "Invalid or missing cookie")
		return
	}

	if err := cookie.Valid(); err != nil {
		t.errorResponse(w, http.StatusBadRequest, "Invalid or missing cookie")
		return
	}
	...
	if err != nil {
		if errors.Is(err, sql.ErrNoRows) {
			t.errorResponse(w, http.StatusUnauthorized, "Invalid or expired token")
			return
		}
