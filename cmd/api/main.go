...
func main() {
	...
	app.Handle("PATCH /v1/me/change-username", app.AuthMiddleware(http.HandlerFunc(app.UserUpdateUsername)))
	app.Handle("PATCH /v1/me/reset-password", app.AuthMiddleware(http.HandlerFunc(app.UserUpdatePassword)))
